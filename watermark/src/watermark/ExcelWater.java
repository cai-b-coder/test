...
public class ExcelWater {
	 ...
	 * @throws IOException
	 */
	public static void putWaterRemarkToExcel(Workbook wb, Sheet sheet, String waterRemarkPath,int coloum,int row) throws IOException {
...
//						5, 5+waterRemarkWidth, 5+waterRemarkHeight);
		ClientAnchor anchor = drawing.createAnchor(0, 0, 0, 0, coloum,row, 0, 0);
